...
public class ConfigExamplePlugin extends Plugin
{
	...
	{
		log.info("Config Example started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Config Example stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Config Example says " + config.greeting(), null);
		}
	}
